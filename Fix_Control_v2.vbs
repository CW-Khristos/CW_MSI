''FIX_CONTROL_V2.VBS
''DESIGNED TO FIX TAKE CONTROL (NC AND STANDALONE)
...
if (errRET = 0) then                                        ''NO ERRORS DURING INITIAL START
  ...
  if ((intRET = 4) or (intRET = 10) or (intRET = 11) or (intRET = 1) or (intRET = 2147221505) or (intRET = 2147221517)) then
    ...
    call HOOK("sc stop " & chr(34) & "BASupportExpressSrvcUpdater" & chr(34))
    call HOOK("sc stop " & chr(34) & "BASupportExpressStandaloneService" & chr(34))
    ...
    call HOOK("sc delete " & chr(34) & "BASupportExpressSrvcUpdater" & chr(34))
    call HOOK("sc delete " & chr(34) & "BASupportExpressStandaloneService" & chr(34))
  end if
