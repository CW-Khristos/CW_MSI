...
if (errRET = 0) then                                        ''NO ERRORS DURING INITIAL START
  ...
  if ((intRET = 4) or (intRET = 10) or (intRET = 11) or (intRET = 1) or (intRET = 2147221505) or (intRET = 2147221517)) then
    objOUT.write vbnewline & now & vbtab & vbtab & " - NO UPDATE FOUND : PMESERVICE_FIX : " & strVER
    objLOG.write vbnewline & now & vbtab & vbtab & " - NO UPDATE FOUND : PMESERVICE_FIX : " & strVER
    ...
    call FILEDL("https://raw.githubusercontent.com/CW-Khristos/CW_MSI/master/PME_Removal.vbs", "C:\IT\Scripts", "PME_Removal.vbs")
